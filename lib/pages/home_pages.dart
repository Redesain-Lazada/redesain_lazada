...
import 'package:redesain_lazada/pages/inbox_page.dart';
import 'package:redesain_lazada/pages/notification_page.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: _buildAppBar(context), // Kirim context ke _buildAppBar
  ...
  Widget _buildSearchBar() {
    return Container(
      ...
      child: Row(
        children: [
          const Icon(Icons.search, color: ColorsItem.primary),
          Expanded(
            child: TextField(
